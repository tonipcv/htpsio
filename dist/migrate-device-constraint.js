...
function runMigration() {
    return __awaiter(this, void 0, void 0, function () {
        var sqlPath, sql, commands, _i, commands_1, command, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, 6, 8]);
                    console.log('Iniciando migração...');
                    sqlPath = path_1.default.join(process.cwd(), 'prisma/migrations/20250702222408_add_device_unique_constraint.sql');
                    sql = fs_1.default.readFileSync(sqlPath, 'utf8');
                    commands = sql
                        .split(';')
                        .map(function (cmd) { return cmd.trim(); })
                        .filter(function (cmd) { return cmd.length > 0; });
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.$executeRawUnsafe(command + ';')];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
